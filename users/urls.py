...
from users.views import (
    AnnouncementFormDetailView,
    AnnouncementFormListCreateView,
    PhoneVerifyView,
...
urlpatterns = [
    ...
    path("announcement-forms/", AnnouncementFormListCreateView.as_view()),
    path("announcement-forms/<int:pk>/", AnnouncementFormDetailView.as_view()),
